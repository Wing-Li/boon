 ...
 * 2016/4/7.
 */
public class WanAndroidAdapter extends MyBaseAdapter<WanAndroidEntity.DataBean.DatasBean> {

    public WanAndroidAdapter(Context context, List<WanAndroidEntity.DataBean.DatasBean> items, int layoutResId) {
