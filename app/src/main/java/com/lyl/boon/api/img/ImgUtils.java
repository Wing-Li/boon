...
public class ImgUtils {
     ...
     */
    public static void load(Context context, String url, ImageView imageView, float thumbnail, int scaleType, DiskCacheStrategy diskCacheStrategy) {
        if (scaleType == TYPE_NULL) {
            Glide.with( context ).load( url ).placeholder( placeholderRes ).error( errorRes ).thumbnail( thumbnail ).diskCacheStrategy( diskCacheStrategy )
                    .into( imageView );
